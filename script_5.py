...
deployment_guide = '''# 🚀 Quick Deployment Guide for Atelier by Minnakshi
...
print("="*50)
print("\nFiles created:")
print("1. ✅ index.html - Your complete website")
print("2. ✅ README.md - Documentation") 
print("3. ✅ package.json - NPM configuration")
print("4. ✅ .gitignore - Git ignore file")
print("5. ✅ CNAME - Custom domain config") 
print("6. ✅ DEPLOYMENT.md - Quick deployment guide")
print("\nYour website is ready to deploy to GitHub, Netlify, Vercel, or any web server!")
print("Check DEPLOYMENT.md for step-by-step instructions.")